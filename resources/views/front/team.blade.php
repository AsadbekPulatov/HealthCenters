        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.3s">
                <div class="team-item rounded">
                    ...
                    <div class="team-content text-center border border-primary border-top-0 rounded-bottom p-4">
                        <h5>MUHAMMEDOV XUSNITDIN ZUXUROVICH</h5>
                        <p class="mb-0">KAFEDRA MUDIRI, NEVROPATOLOG, TIBBIYOT FANLARI NOMZODI, O‘ZBEKISTON RESPUBLIKASIDA XIZMAT KO‘RSATGAN SHIFOKOR</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.5s">
                <div class="team-item rounded">
                    ...
                    <div class="team-content text-center border border-primary border-top-0 rounded-bottom p-4">
                        <h5>КАХХАРБЕКОВА АЗИЗА КАЗИМБЕКОВНА</h5>
                        <p class="mb-0">ВРАЧ-ТЕРАПЕВТ</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                <div class="team-item rounded">
                    ...
                    <div class="team-content text-center border border-primary border-top-0 rounded-bottom p-4">
                        <h5>АШУРОВА ХАФИЗА ХУДОЙНАЗАРОВА</h5>
                        <p class="mb-0">ВРАЧ-ТЕРАПЕВТ</p>
                    </div>
                </div>
            </div>
